...
const projects = [
  {
    title: 'RELICT',
    description: 'Разработка премиального корпоративного сайта под ключ для ресторана и бара современной русской кухни. Создан стильный дизайн в темных тонах, интегрирована система бронирования столов, интерактивное меню и раздел событий.',
  ...
  {
    title: 'ScandyStyle',
    description: 'Создание интернет-магазина мебели под заказ от фабрики. Интерактивный каталог с фильтрацией, выбор тканей и материалов, форма заявки на бесплатный 3D-проект.',
  ...
  {
    title: '4hands',
    description: 'Разработка корпоративного сайта для сети салонов красоты 4hands. Создан каталог услуг с подробным описанием и ценами, интегрирована удобная онлайн-запись и стильный светлый дизайн для женской аудитории.',
  ...
  {
    title: 'Ваш Эксперт',
    description: 'Создание лендинга и корпоративного сайта для независимой оценочной компании — под ключ от дизайна до деплоя. Форма захвата лидов, уведомления в Telegram, SEO-оптимизация под Яндекс, страница услуг с ценами.',
  ...
  },
  {
    ...
    description: 'За время работы мы успешно реализовали множество проектов — от продающих лендингов и корпоративных порталов до сложных веб-приложений. Планируете заказать разработку сайта? Мы всегда готовы обсудить вашу задачу.',
